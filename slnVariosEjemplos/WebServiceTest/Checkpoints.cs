...
namespace Script
{
    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_StServiceCallActivity9_checkpoints(STActivityBase activity)
        {
            ...
            BindDirection actualBindDirection2 = new BindDirection(_flow.StServiceCallActivity9, actualValueGetter2, actualValueSetter2);
            CpValObj valueActualObject2 = new CpValObj(actualBindDirection2, XmlTypeCode.Int, false);
            CpValObj valueExpectedObject2 = new CpValObj("106", XmlTypeCode.Int);
            ...
            BindDirection actualBindDirection3 = new BindDirection(_flow.StServiceCallActivity9, actualValueGetter3, actualValueSetter3);
            CpValObj valueActualObject3 = new CpValObj(actualBindDirection3, XmlTypeCode.Float, false);
            CpValObj valueExpectedObject3 = new CpValObj("462.4", XmlTypeCode.Float);
